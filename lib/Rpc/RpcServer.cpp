...
{
    Crypto::Hash tx_hash = Qwertycoin::NULL_HASH;
    Crypto::Hash tx_prefixt_hash = Qwertycoin::NULL_HASH;
    Transaction tx;
    ...
    COMMAND_RPC_SEND_RAW_TX::response &res)
{
    ...
    if (!m_fee_address.empty() && m_view_key != Qwertycoin::NULL_SECRET_KEY) {
    ...
    COMMAND_RPC_GETBLOCKHASH::response &res)
{
    ...
    if (blockId == Qwertycoin::NULL_HASH) {
        throw JsonRpc::JsonRpcError{
            CORE_RPC_ERROR_CODE_TOO_BIG_HEIGHT,
            std::string("To big height: ")
                + std::to_string(h)
    ...
    COMMAND_RPC_GETBLOCKTEMPLATE::response &res)
{
    ...
    if (tx_pub_key == Qwertycoin::NULL_PUBLIC_KEY) {
    ...
    K_COMMAND_RPC_CHECK_TX_PROOF::response &res)
{
    ...
    if (R == Qwertycoin::NULL_PUBLIC_KEY) {
        throw JsonRpc::JsonRpcError{
            CORE_RPC_ERROR_CODE_INTERNAL_ERROR,
