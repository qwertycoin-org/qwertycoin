...
namespace {
  ...
  const size_t TEST_CONSOLIDATE_TRANSACTION_SPENDABLE_AGE = 1;
  ...
  public:
    ...
    TransfersContainerTest() :
      ...
      container(currency, logger, TEST_TRANSACTION_SPENDABLE_AGE, TEST_CONSOLIDATE_TRANSACTION_SPENDABLE_AGE),
