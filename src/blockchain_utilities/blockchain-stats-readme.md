# Qwertycoin Blockchain Stats

Qwertycoin Blockchain Stats utility exports daily statistics for the qwertycoin blockchain from creation through current state.

## Usage:

See also the utility's help option. `qwertycoin-blockchain-stats --help`
...
- `qwertycoin-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `qwertycoin-blockchain-stats | save-to-database.sh`
