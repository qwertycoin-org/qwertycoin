...
int registerService()
{
    ...
    for (;;) {
        ...
        scService =
                CreateService(scManager, SERVICE_NAME, NULL, SERVICE_QUERY_STATUS,
...
int unregisterService()
{
    ...
    for (;;) {
        ...
        scService =
                OpenService(scManager, SERVICE_NAME, SERVICE_STOP | SERVICE_QUERY_STATUS | DELETE);
        if (scService == NULL) {
            logRef(Logging::FATAL, Logging::BRIGHT_RED)
...
int main(int argc, char **argv)
{
    ...
    try {
        ...
        Logging::LoggerRef(pg.getLogger(), "main")(Logging::INFO)
                << "walletd v" << PROJECT_VERSION_LONG;
