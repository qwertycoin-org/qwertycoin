...
| F08 | **Design specified; implementation open / P0** | `reward_source_epoch_for_height()` maps v1 epoch 0 to itself. CO-01 reserves a two-epoch v2 warm-up, pre-payout evidence deadline, and boundary vectors without changing v1. | CO-02: implement frozen snapshots, closed qualification sets, and reorg vectors under the reserved transition. |
