...
1. Connect typed v2 P2P semantic ingestion and pool-to-template insertion, then implement lifecycle/admission/receipt construction and canonical service probing; keep every legacy-v1 producer fail-closed.
